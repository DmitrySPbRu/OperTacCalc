...
public class EffScattArea {
    public static void main(String[] args) {
        double sigma=0, dOb, lOb, wOb, lambda, rOb, alfa, sigmaTet=0,
                tetObjGrad=0, tetObjRad=0;
        short typeOb;
        ...
        switch (typeOb) {
            ...
            {   System.out.print("Input length of object (m): ");
                ...
                sigmaTet = sigma * cos(tetObjRad); break; }
            ...
            {   System.out.print("Input length of edge (m): ");
                lOb = in.nextDouble();
                sigma = (4*PI*pow(lOb,4))/(3*(pow(lambda,2))); break; }
            ...
            {   System.out.print("Input diameter of object (m): ");
                dOb = in.nextDouble(); rOb = dOb/2;
                sigma = (4*pow(PI,3)*pow(rOb,4))/pow(lambda,2); break; }
